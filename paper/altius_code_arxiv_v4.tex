...
\input{figures/fig_commutative_wrapper}
...
\begin{itemize}[nosep]
\item Bijectivity on MNI152 — \texttt{proto\_s1\_brain.py}
\item Inter-patient stability — \texttt{proto\_s2\_interpatient.py}
\item DPCM compression — \texttt{proto\_s4\_dpcm.py}
\item FEM bandwidth — \texttt{proto7\_improved.py}
\item Surface morphing — \texttt{proto\_s6\_surface.py}
\end{itemize}
